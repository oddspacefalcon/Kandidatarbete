...
system_size = 5
predict_nr = 1
network = NN_11 # Valid network names: NN_11, NN_17, ResNet18, ResNet34, ResNet50, ResNet101, ResNet152
...
plot_range = 1 # plot from P_error = 0.01 to plot_range*0.01
plot_one_episode = False
########################################
PATH = predict(plot_range, predict_nr, device, system_size, network, NETWORK_FILE_NAME, num_of_predictions, plot_one_episode)
#PATH  = 'Results/prediction__size_5_Go_size_5_NN_11_steps_epoch_7_steps_7000__20_04_15__10__'
plot(PATH, plot_range)
